...
<section class="w-full pb-20 pt-10">
    ...
    <div class="w-[70%] px-20 flex flex-col">
        <div class="w-full flex flex-col">
            <div class="bg-white rounded-t-2xl border-[#8c8c8c] p-4 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] flex flex-row">
            ...
            <div class="flex flex-col ">
                ...
                <div class="bg-white flex justify-between items-center px-6 py-2 text-sm">
                    <div class="w-[25%] text-[#635549]">Metode Pembayaran</div>
                    <div class="w-[45%] text-[#635549]">{{ $dataPenjualan->metode }}</div>
                </div>
                <div class="bg-white flex justify-between items-center px-6 pb-6 font-bold text-2xl border-gray-500 rounded-b-2xl">
